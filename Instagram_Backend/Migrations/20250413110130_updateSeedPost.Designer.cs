...
namespace Instagram_Backend.Migrations
{
    ...
    [Migration("20250413110130_updateSeedPost")]
    partial class updateSeedPost
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Instagram_Backend.Models.Post", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            Id = new Guid("33275ae4-f405-4f6a-983a-ad5bec64abde"),
                            Caption = "Beautiful sunset at the beach!",
                            CommentCount = 2,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 15,
                        ...
                        new
                        {
                            Id = new Guid("1db23406-a17b-4dc8-bea7-2beac2933616"),
                            Caption = "Beautiful sunset at the beach!",
                            CommentCount = 2,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 15,
                        ...
                        new
                        {
                            Id = new Guid("e7f3533b-b28c-41da-8a19-5bb165d295ec"),
                            Caption = "Beautiful sunset at the beach!",
                            CommentCount = 2,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 15,
                        ...
                        new
                        {
                            Id = new Guid("8054e0e8-68e1-46d2-987d-4132868e3b72"),
                            Caption = "Beautiful sunset at the beach!",
                            CommentCount = 2,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 15,
                        ...
                        new
                        {
                            Id = new Guid("4410a87d-a7d8-4608-9355-6a612888d6d1"),
                            Caption = "Beautiful sunset at the beach!",
                            CommentCount = 2,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 15,
                        ...
                        new
                        {
                            Id = new Guid("4a5ba864-e9e8-42e2-b7a9-061f4c789e63"),
                        ...
                        new
                        {
                            Id = new Guid("8764c2ac-7fc1-49ae-bd74-25d366a2fe4e"),
                            Caption = "My homemade pasta recipe 🍝",
                            CommentCount = 3,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 42,
                        ...
                        new
                        {
                            Id = new Guid("835d699d-9448-4340-9475-25b73b2e244a"),
                            Caption = "New coding setup complete",
                            CommentCount = 4,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 28,
                        ...
                        new
                        {
                            Id = new Guid("90b398a9-db7d-479e-88b7-d8e704a24d6e"),
                            Caption = "New coding setup complete",
                            CommentCount = 4,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 28,
                        ...
                        new
                        {
                            Id = new Guid("52ad77c5-1da0-444b-b125-5f85bc231b7a"),
                            Caption = "New coding setup complete",
                            CommentCount = 4,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 28,
                        ...
                        new
                        {
                            Id = new Guid("75a6a545-2e08-4b67-a1fe-86f35d703b19"),
                            Caption = "New coding setup complete",
                            CommentCount = 4,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 28,
                        ...
                        new
                        {
                            Id = new Guid("a6505049-5dcb-43ec-bbbc-021cad8cacb9"),
                            Caption = "New coding setup complete",
                            CommentCount = 4,
                            CreatedAt = new DateTime(2025, 3, 15, 0, 0, 0, 0, DateTimeKind.Utc),
                            LikeCount = 28,
            ...
            modelBuilder.Entity("Instagram_Backend.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "18b61af4-63d7-4db3-9296-6c171e95303b",
                            ...
                            SecurityStamp = "38cb28e5-3f8a-45da-9a6f-51f8ef1925c4",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "33a7ad33-02cc-42b1-9da2-e4113e226c8d",
                            ...
                            SecurityStamp = "13275aef-b9e8-4c26-bdda-8168aaecd01c",
                            TwoFactorEnabled = false,
                            UserName = "janesmith"
                        },
                        new
                        {
                            ...
                            ConcurrencyStamp = "2219cfa2-8539-4e2f-81a1-3c9a50149dae",
                            ...
                            SecurityStamp = "9f47581a-31e0-4f9c-84f3-8ccfa0427ad0",
                            TwoFactorEnabled = false,
                            UserName = "alexj"
                        });
                });
